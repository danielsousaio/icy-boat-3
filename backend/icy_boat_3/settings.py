"""
Django settings for icy_boat_3 project.
...
WSGI_APPLICATION = 'icy_boat_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "icy_boat_3 API",
    "DESCRIPTION": "API documentation for icy_boat_3 App",
    "VERSION": "v1",
}
